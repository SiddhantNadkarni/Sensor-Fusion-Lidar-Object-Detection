...
public:
    ...
    void Proximity(int indice, typename pcl::PointCloud<PointT>::Ptr& cloud, std::vector<int>& cluster, std::vector<bool>& pointMark, KdTree<PointT>* tree, float distanceTol);
